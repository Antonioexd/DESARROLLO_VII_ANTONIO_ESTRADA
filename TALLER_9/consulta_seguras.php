...
function filtrarProductos($pdo, array $criterios) {
...
function generarReporte($pdo, array $campos, array $filtros) {
    $qb = new QueryBuilder($pdo);
    $qb->table('productos p')->select($campos);
