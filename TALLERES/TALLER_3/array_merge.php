...
$misComidas = ["Sushi", "lasaña", "carne"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["pollo", "patacon", "pescado   "]; // Reemplaza con las comidas favoritas de tu amigo
...
$array1 = ["Grupo 1" => "Futbol", "Grupo 2" => "Baloncesto"];
$array2 = ["Grupo 3 " => "beisball", "grupo 4" => "atletismo"];
