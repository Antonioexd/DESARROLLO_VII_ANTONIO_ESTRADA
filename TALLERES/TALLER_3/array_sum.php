...
// Crear un array asociativo que represente productos y sus precios
$productos = [
    "Laptop" => 800,
    "Teléfono" => 500,
    "Tablet" => 300,
...
// Usar array_sum() para calcular el total de los precios
$total = array_sum($productos);

// Mostrar el total
echo "El total de todos los productos es: $total";

// Array asociativo de frutas con sus precios por kilogramo
$frutas = [
    "Manzana" => 3.00,
    "Banana" => 1.50,
    "Cereza" => 4.00,
...
// Aplicar un descuento del 20% a cada precio usando array_map()
$preciosConDescuento = array_map(function($precio) {
    return $precio * 0.80; // Aplica un 20% de descuento
}, $frutas);

// Calcular el total de los precios con el descuento aplicado
$totalConDescuento = array_sum($preciosConDescuento);
