...
$frutas = ["manzana", "banana", "cereza", "dátil","musica", "laptop","compositor","artista"];
...
$nombres = ["Ana", "Carlos", "Beatriz","Felipe","Valentin","Marcos"];
$apellidos = ["García", "Rodríguez", "López","Barrios","Saez","Robles"];
...
$productosConDescuento = [
    ["nombre" => "Producto A", "precio" => 100, "precio_descuento" => 80],
    ["nombre" => "Producto B", "precio" => 200, "precio_descuento" => 150],
];
...
// Definir la función para aplicar un descuento
function aplicarDescuento($productos, $porcentajeDescuento) {
    return array_map(function($producto) use ($porcentajeDescuento) {
        $producto['precio_descuento'] = $producto['precio'] * (1 - $porcentajeDescuento / 100);
        return $producto;
    }, $productos);
}
...
// Aplicar un 10% de descuento a los productos
$productosConDescuento = aplicarDescuento($productos, 10);
