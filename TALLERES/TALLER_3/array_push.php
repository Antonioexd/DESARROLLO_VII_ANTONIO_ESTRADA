...
$misAmigos = ["Marcos","Valentin","Valeria"]; // Reemplaza esto con tu array de amigos
echo "</br>array original de nombres de mis amigos:</br>";
print_r($misAmigos);

array_push($misAmigos, "Eva", "Rafa"); // Reemplaza las comillas vacías con los nombres de tus amigos
